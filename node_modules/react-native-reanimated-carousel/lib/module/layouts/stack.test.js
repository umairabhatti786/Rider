import { horizontalStackLayout, useHorizontalStackLayout, verticalStackLayout } from "./stack"; // Mock react-native-reanimated
...
describe("horizontalStackLayout", () => {
  ...
  it("should handle custom parameters", () => {
    ...
    expect(result).toHaveProperty("transform");
    expect(result.transform).toHaveLength(3);
    expect((_result$transform = result.transform) === null || _result$transform === void 0 ? void 0 : _result$transform[2]).toHaveProperty("rotateZ");
  });
});
describe("verticalStackLayout", () => {
  it("should handle left snap direction", () => {
    var _result$transform2;
    ...
    expect((_result$transform2 = result.transform) === null || _result$transform2 === void 0 ? void 0 : _result$transform2[3]).toHaveProperty("translateY");
  });
  it("should handle right snap direction", () => {
    var _result$transform3;
    ...
    expect((_result$transform3 = result.transform) === null || _result$transform3 === void 0 ? void 0 : _result$transform3[3]).toHaveProperty("translateY");
  });
  it("should handle default config", () => {
    const calculator = verticalStackLayout();
    const result = calculator(0);
