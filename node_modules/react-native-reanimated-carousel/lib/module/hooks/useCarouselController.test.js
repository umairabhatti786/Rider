...
describe("useCarouselController edge cases and uncovered lines", () => {
  ...
  it("should handle scrollTo() without animation when target equals current index - uncovered line 265", () => {
    ...
    const onFinished = jest.fn(); // Try to scroll to same index
  ...
  it("should handle overscroll protection when overscrollEnabled is false", () => {
    const restrictedGlobalState = { ...mockGlobalState,
      props: { ...mockGlobalState.props,
        overscrollEnabled: false
      },
      layout: { ...mockGlobalState.layout,
        containerSize: {
          value: {
            width: 300,
            height: 300
    ...
    const restrictedWrapper = _ref2 => {
      let {
        children
      } = _ref2;
      return /*#__PURE__*/React.createElement(GlobalStateContext.Provider, {
        value: restrictedGlobalState
      }, children);
    };
