...
describe("useCommonVariables", () => {
  ...
  it("should calculate defaultHandlerOffsetValue correctly with non-zero defaultIndex", () => {
    const inputWithDefaultIndex = { ...input,
      defaultIndex: 2
    };
  ...
  it("should use custom defaultScrollOffsetValue when provided", () => {
    ...
    const inputWithCustomOffset = { ...input,
  ...
  it("should handle negative defaultIndex", () => {
    const negativeIndexInput = { ...input,
      defaultIndex: -1
    };
  ...
  it("should update when props change", () => {
    ...
    expect(hook.result.current.size).toBe(700); // Update width
  ...
  it("should handle dataLength changes", () => {
    ...
    expect(hook.result.current.validLength).toBe(3); // Update dataLength
  ...
  it("should handle vertical with zero height", () => {
    const verticalZeroHeightInput = { ...input,
      vertical: true,
      height: 0
    };
